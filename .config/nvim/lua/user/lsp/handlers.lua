...
-- I think this is vim-level display configs...will want to run this M.setup()
M.setup = function()
  local signs = {
...
-- This ought to work...with some tweaks
...
M.on_attach = function(client, bufnr)
  ...
  -- Enable completion triggered by <c-x><c-o> -- not sure I want this...
